  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button"  id="addPopupClose" class="close btn-close" onclick="closeDeleteModal()" data-dismiss="modal" aria-label="Close" >
      ...
      <div class="modal-footer justify-content-end">
        <button type="button" class="btn btn-default" onclick="closeDeleteModal()" data-dismiss="modal">Cancel</button>
...
<%--      </div>--%>
<%--      <div class="modal-footer justify-content-end">--%>
<%--        <button type="button" class="btn btn-default" onclick="closeDeleteModal()" data-dismiss="modal">Close</button>--%>
<%--      </div>--%>
<%--    </div>--%>
<%--    <!-- /.modal-content -->--%>
<%--  </div>--%>
